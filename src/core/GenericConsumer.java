...
public abstract class GenericConsumer<S> extends Thread{			//design pattern de comandos, as mensagens tem tipos
																															//atraldos a uma função
	...
	protected void loadCommandProperties(){					//carregar comandos
