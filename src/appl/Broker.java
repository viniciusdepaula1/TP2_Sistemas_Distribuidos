...
public class Broker {				//brocker só recebe não publica
											//alguem vai ganhar o acesso  graças a thread unica
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		new Broker();
	}
	
	public Broker(){		//wrapper de um servidor -- só starta o servidor
